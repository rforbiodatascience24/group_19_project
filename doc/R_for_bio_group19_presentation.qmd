...
>>>>>>> e9f4a72a86317a497cb545bf24db2595a8df8a31
...
## Results: Boxplots {background-color="brown"}
::: columns

::: {.column width="70%" style="font-size: 16px;"}
![](../results/images/05_boxplot_sex_his.png){width="120%"}
...
-   Returns: stratified bar plot ![](../results/images/05_proportion_plot.png){width="100%"}
:::

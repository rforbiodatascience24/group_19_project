...
![](../results/images/barplot_STD.png){width="100%"}
...
::: columns
::: {.column width="50%"}
![](results/images/boxplot_sex_his.png){width="120%"}
:::
...
::: columns
::: {.column width="50%"}
![](results/images/PCA_code.png){width="100%"}
:::

::: {.column width="50%"}
![](results/images/scatterplot_pca.png){width="100%"}
:::
:::

## Results: Principal Component Analysis {background-color="brown"}

::: columns
::: {.column width="50%" style="font-size: 8px;"}
-   Extract the rotation matrix

    -   The rotation matrix in PCA shows how the original variables contribute to each principal component (PC)

-   Arrows pointing in similar directions indicate positive correlation

-   Arrows pointing in opposite directions indicate negative correlation

-   Arrows near the origin have minimal contribution to the components

-   The length of an arrow indicates how strongly that variable contributes to the principal components

![](results/images/PC_coordinates.png){width="50%"}
:::
...
![](results/images/PC_variance.png){width="50%"}
:::

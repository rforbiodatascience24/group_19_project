...
#save plot
ggsave("~/projects/project_r4bd/doc/results/images/boxplot_sex_his.png", plot = boxplot_sex_his)
...
#save plot
ggsave("~/projects/project_r4bd/doc/results/images/barplot_STD.png", plot = barplot_STD)
```

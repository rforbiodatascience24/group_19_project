...
>>>>>>> d872ab3725e5313e3614b1227249153893bc0224
=======
First, we are renaming the two smoke columns to match the others syntax. Next, we change the columns two numeric values.
=======
>>>>>>> 61672f25face958e91518dad245bb8ea4aed0378
=======

First, we are renaming the two smoke columns to match the others syntax. Next, we change the columns to numeric values.
>>>>>>> dc2ff7b5f2d24659057e28b4b70e0d8f8adbc21c
...
ggplot(data = data_long, aes(x = STD, fill = Dx_Cancer)) +
  geom_bar(stat = "identity", position = "dodge") +
  facet_grid(~Dx_Cancer) +
  labs(title = "Normalized Counts of STD by Cancer Diagnosis",
       x = "STD",
